...
class Product():
    ...
    def draw_charts(self):
        ...
        recommendation.plot.pie(
            ...
            colors = ["crimson", "limegreen", "deepskyblue"],
    ...
    def stats_to_dict(self):
        return {
            "ID produktu": self.product_id,
            "Nazwa": self.product_name,
            "Liczba opinii": self.opinions_count,
            "Liczba zalet": self.pros_count,
            "Liczba wad": self.cons_count,
            "Średnia ocena": self.average_score,
        }
